...
No capítulo seguinte, avança-se em direção da discussão empírica e é estimado um modelo vetor de correção de erros (VECM) para testar a capacidade explicativa da taxa de juros real dos imóveis.
...
\begin{otherlanguage*}{english}
	...
	This thesis investigates the relationship between residential investment, asset inflation, and medium-term macroeconomic dynamics based on the US case post-deregulation (1992-2019). 
	In the first chapter, a literature review of demand-led growth models is made, choosing the Sraffian supermultiplier (SSM) as the best model to achieve the objectives of this research. 
	...
	In the third chapter, a Sraffian Supermultiplier Stock-Flow Consistent model (SSM-SFC) with asset inflation is simulated prioritizing parsimony to represent a closed, without governed economy with working and capitalist families in which only the latter have access to credit to finance both consumption and residential investment. 
	...
	\noindent\textbf{Keywords}: Sraffian Supermultiplier; real state, own interest rate, Vector Error Correction Model, Stock-Flow Consistent. 
