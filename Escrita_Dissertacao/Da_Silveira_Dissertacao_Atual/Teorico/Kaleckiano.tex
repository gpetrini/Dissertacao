...
Outra crítica aos modelos kaleckianos --- que se estende ao modelo de Cambridge --- é a ausência de gastos autônomos não criadores de capacidade produtiva ($Z$).
Esses são dois pontos de conflito entre o modelo kaleckiano tradicional e o supermultiplicador sraffiano. A subseção seguinte aborda esta outra proposta à instabilidade de Harrod. 
