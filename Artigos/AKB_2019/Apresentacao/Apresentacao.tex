...
Quais as condições para que demanda e capacidade produtiva cresçam dinamicamente equilibradas?
\end{alert}
...
\begin{frame}{Representação do modelo}
...
\item
  ...
  \tightlist
  \item
    Maior wage-share não afeta a taxa de crescimento de longo prazo
  \item
    Maior taxa de juros gera maior endividamento das famílias
  \end{itemize}
\item
