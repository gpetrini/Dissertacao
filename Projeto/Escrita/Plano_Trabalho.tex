...
A tabela \ref{crono} apresenta um esboço das atividades a serem desempenhadas ao longo desta pesquisa em que estão destacadas em vermelho as frentes mencionadas anteriormente, em laranja as etapas necessárias para concluir cada uma delas e em cinza as obrigações institucionais.
